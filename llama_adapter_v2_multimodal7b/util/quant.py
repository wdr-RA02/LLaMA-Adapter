# from https://github.com/luogen1996/LaVIN/blob/main/util/quantization.py
...
def quant_model_bnb(model, quant_bit='8bit', keep_in_fp32_modules=None,
                    quantization_config=None):
    # quit on other args
    if quant_bit not in ["8bit", "4bit"]:
    ...
    print("Quant the model to {}".format(quant_bit))
